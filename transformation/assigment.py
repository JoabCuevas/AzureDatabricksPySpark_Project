...
results_drivers_df = drivers_df.join(results_df, results_df.driver_id == drivers_df.driver_id, "inner").select(drivers_df.driver_name, drivers_df.driver_number, drivers_df.driver_nationality, results_df.grid, results_df.fastest_lap, results_df.race_time, results_df.points, results_df.constructor_id, results_df.race_id)
...
final_df.write.parquet(f"{presentation_folder_path}/race_results")
